locals {
  my_list = [
    "arn:aws:sqs:ap-southeast-2:12345:communicate-COM-DATASTAGING-previews-dlq",
    "arn:aws:sqs:ap-southeast-2:12345:communicate-COM-DATASTAGING-commands-dlq"
  ]
}
...
data "null_data_source" "my_list_base_names_ds" {
  ...
  inputs = {
    value = "${replace(local.my_list[count.index], "arn:aws:sqs:ap-southeast-2:12345:communicate-COM-DATASTAGING-", "")}"
  }
}
